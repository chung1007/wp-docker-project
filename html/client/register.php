...
<html>
	...
	<body>
		<center> <h2 class="reg-header"> Register</h2> </center><br>
		<div class="reg_container">
			<form method="post" action="client_register.php" autocomplete="off">
				<!-- <h3> Login Information </h3>
				<hr><br> -->
				<p><strong>Username:&emsp;</strong><input type="text" name="login" size="20" maxlength="20" placeholder="Choose your username"></p>
				<p><strong>Password:&emsp;</strong><input type="password" name="pass" size="20" placeholder="Choose your password"></p><br>
				...
				<p><strong>Phone Number:&emsp;</strong><input type="text" name="phone" size="20" maxlength="20" placeholder="Enter your phone number" required></p>
